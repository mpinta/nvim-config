...
require("mpinta.plugins.lualine")
require("mpinta.plugins.mason")
require("mpinta.plugins.namu")
require("mpinta.plugins.neoscroll")
require("mpinta.plugins.nvim-cmp")
require("mpinta.plugins.nvim-lint")
require("mpinta.plugins.nvim-telescope")
require("mpinta.plugins.nvim-tree")
...
require("mpinta.plugins.zen-mode")
